import { A as AstroError, U as UnknownContentCollectionError, a as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, d as renderTemplate, l as escape, n as renderUniqueStylesheet, o as renderScriptElement, p as createHeadAndContent, e as renderComponent } from './astro/server_tK7xiX1Y.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DGbjvbEC.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://astro-nano-demo.vercel.app", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_OkbIZtOD.mjs').then(n => n._);
