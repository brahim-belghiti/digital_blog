---
title: "Coupling: What It Is, Why It Matters"
description: "Coupling is how deeply components in a system depend on each other. Controlling it — through interfaces, dependency inversion, and injection — is one of the main tools for managing complexity."
date: "May 30 2026"
tags: ["architecture", "coupling", "dependency-injection", "interfaces", "complexity", "separation-of-concerns"]
url: "coupling-what-it-is-why-it-matters"
---

Coupling is the level of how components of a system are linked and dependent on each other. It is one of the practical tools for managing [essential complexity](./essential-vs-accidental-complexity) — by controlling how much components know about each other, we control how much change propagates through the system.
...
[Separation of concerns](./separation-of-concerns-as-meta-principle) is how you achieve low coupling — by disentangling interleaved concerns, you reduce how much any one module needs to know about others.
